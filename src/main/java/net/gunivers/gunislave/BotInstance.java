...
public class BotInstance {
	...
	if (config.token == null)
	    ...
	    // En cas de déconnection imprévue, tente de se reconnecter à l'infini
	    builder.setRetryOptions(
		    new RetryOptions(Duration.ofSeconds(30), Duration.ofMinutes(1), 1000, Schedulers.single()));
	    ...
	    // Initializing Events (nécessaire pour l'initialisation du bots et de ses
	    // données)
